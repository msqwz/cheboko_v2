...
import { Wrench, Calendar, Gauge, Droplet, MapPin, Building, CheckCircle, Clock, Filter, Search } from 'lucide-react';
...
export const MaintenancePage = () => {
  const { currentUser, maintenanceRecords, users, rolePermissions } = useAppContext();
  ...
  const getEngineerName = (engineerId?: string) => {
    ...
    return engineer ? engineer.name : 'Неизвестно';
  };
            ...
            <div className="flex-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Клиент, объект, оборудование..."
                  value={searchQuery}
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Клиент / Объект</th>
                  ...
                  <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Дата выполнения</th>
                  <th className="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">
                    <Gauge className="h-4 w-4 inline" /> Напитки
                  </th>
                  <th className="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">
                    <Droplet className="h-4 w-4 inline" /> Очистки
                  </th>
                    ...
                    <tr key={record.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-4 py-4 whitespace-nowrap">
                        ...
                        <p className="text-xs text-gray-500">
                          {format(new Date(record.completedAt), 'HH:mm', { locale: ru })}
                        </p>
                      </td>
                      <td className="px-4 py-4 text-center">
                        <span className="inline-flex items-center px-2.5 py-1 rounded-md text-sm font-medium bg-indigo-50 text-indigo-700">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-indigo-700 mt-1">
                ...
                Статус «Выполнено» — работы проведены. Статус «Рекомендовано» — запланированное ТО.
              </p>
            </div>
          </div>
        </div>
